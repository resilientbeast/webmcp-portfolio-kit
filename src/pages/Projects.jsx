...
function Projects({ fitMap, engagementOptions, discoveryBrief }) {
    ...
    const archive = profile.profile.project_archive
        ...
        <div className="projects-page">
            <section className="projects-hero section">
                <div className="container">
                    ...
                    <p className="page-subtitle">{archive.summary}</p>
                </div>
            </section>

            <section className="projects-list section"><div className="container"><div className="section-header"><span className="font-mono text-primary">{archive.active_command}</span><span className="font-mono text-dim">Active: {activeProjects.length} projects</span></div><div className="projects-grid">{activeProjects.map(project => <ProjectCard key={project.id} {...projectCard(project)} />)}</div></div></section>
