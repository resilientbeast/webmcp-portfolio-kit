...
| 0:25–0:42 | Open `config/site.config.json` and `content/profile.json` side-by-side briefly, then return to the site. Use a simple highlight overlay: **config / content / generic code**. | “I extended an existing portfolio into a reusable starter kit. Forkers change a small site configuration and a structured profile file; the UI, matching layer, and WebMCP contract stay generic.” |
...
| 2:18–2:34 | Show the public GitHub repo, MIT license, README’s Deploy with Vercel button, then optionally the alternate fixture/test output. | “This is not a bespoke résumé chatbot. The public kit has an open-source license, a one-click Vercel deploy path, and a separate alternate-persona test that proves the matching code is not hardwired to this reference profile.” |
...
| 2:48–2:55* | Return to the live site with DevTools WebMCP panel visible. End on title/repository/live URL. | “WebMCP Portfolio Kit makes professional evidence inspectable by agents, explicit about gaps, and safe at the handoff to a human. That is an agent-native portfolio people can actually trust.” |
...
>
> I extended an existing portfolio into a reusable starter kit. Forkers change a small site configuration and a structured profile file; the UI, matching layer, and WebMCP contract stay generic.
>
...
>
> This is not a bespoke résumé chatbot. The public kit has an open-source license, a one-click Vercel deploy path, and a separate alternate-persona test that proves the matching code is not hardwired to this reference profile.
>
...
>
> WebMCP Portfolio Kit makes professional evidence inspectable by agents, explicit about gaps, and safe at the handoff to a human. That is an agent-native portfolio people can actually trust.
